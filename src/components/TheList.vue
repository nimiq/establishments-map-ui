...
<template>
  ...
  >
    <div
      v-if="!listIsEmpty" :class="{ 'md:!overflow-y-hidden': !listIsShown }"
    ...
    >
      ...
      <ul ref="scroller$" class="space-y-5">
    ...
    >
      ...
      <p class="text-base text-center text-space md:text-xl">
        {{ $t('Oops, no Locations around here') }}
      </p>
    </div>

    <transition
      enter-active-class="duration-200 ease-out" enter-from-class="translate-y-12 opacity-0"
