...
<template>
  <div
    class="p-6 transition-all duration-300 bg-white shadow cursor-default rounded-t-md desktop:rounded-md border border-[#e9e9ed] border-solid desktop:max-w-320"
    ...
    <div class="grid items-center grid-cols-[auto_1fr_auto] grid-rows-2 grid-flow-dense gap-x-2">
      ...
      <button type="button" relative size-24 col-start-3 p-8 ml-auto transition rounded-full text-neutral-100 top--4
